...
Answer:`;
    ...
    window.sendMessage = async function() {
        ...
        try {
            ...
            botMessageDiv.innerHTML = `<strong>🤖 AI Sameer:</strong> ${reply}<div class="message-time">${new Date().toLocaleTimeString()}</div>`;
            ...
            errorDiv.innerHTML = `<strong>🤖 AI Sameer:</strong> ${errorMessage}<div class="message-time">${new Date().toLocaleTimeString()}</div>`;
